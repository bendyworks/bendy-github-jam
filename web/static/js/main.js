...
var _user$project$Storylets_Models$storyletForId = F2(
	function (storyletDict, id) {
		var fetched = A2(_elm_lang$core$Dict$get, id, storyletDict);
		var _p0 = fetched;
		if (_p0.ctor === 'Just') {
			return _p0._0;
		} else {
...
var _user$project$Storylets_Models$initialStoryletList = {
	ctor: '::',
	_0: _user$project$Storylets_Models$introStorylet,
	_1: {
		ctor: '::',
		_0: _user$project$Storylets_Models$demoNextStorylet,
		_1: {
			ctor: '::',
			_0: _user$project$Storylets_Models$moreRubies,
			_1: {
				ctor: '::',
				_0: _user$project$Storylets_Models$fewerRubies,
				_1: {
					ctor: '::',
					_0: _user$project$Storylets_Models$emptyStorylet,
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$Events_Models$initialEventList = function () {
	...
	return {
		ctor: '::',
		_0: {title: 'A transition', body: 'You gained a rubies by transitioning through this event!', id: 0, from: 0, to: 1, onBefore: inventoryFn, onAfter: _user$project$Events_Models$idFn},
		_1: {
			ctor: '::',
			_0: {title: 'Another transition', body: 'Yay! it worked again!', id: 1, from: 1, to: 2, onBefore: _user$project$Events_Models$idFn, onAfter: _user$project$Events_Models$idFn},
			_1: {
				ctor: '::',
				_0: {title: 'The Last Event', body: 'OK now its gonna loop back to the start', id: 2, from: 2, to: 0, onBefore: _user$project$Events_Models$idFn, onAfter: _user$project$Events_Models$idFn},
				_1: {ctor: '[]'}
			}
		}
	};
...
var _user$project$Messages$UpdateFromEditModel = {ctor: 'UpdateFromEditModel'};
...
var _user$project$Messages$CurrId = function (a) {
	return {ctor: 'CurrId', _0: a};
};
...
var _user$project$Editor_Updates$editUpdate = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Title':
			...
			default:
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{title: _p2.title, body: _p2.body, currId: _p2.id});
		}
	});

var _user$project$Editor_Views$storyDisplay = function (model) {
	return A2(
		_evancz$elm_markdown$Markdown$toHtml,
		{ctor: '[]'},
		model.editModel.body);
};
var _user$project$Editor_Views$storyLoadDiv = function (model) {
	var sl = A2(_user$project$Storylets_Models$storyletForId, model.storylets, model.editModel.currId);
	return A2(
				...
				_elm_lang$html$Html$button,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Messages$EditAction(
							_user$project$Messages$Load(sl))),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						_0: _elm_lang$html$Html_Events$onInput(
							function (s) {
								return _user$project$Messages$EditAction(
									_user$project$Messages$CurrId(s));
							}),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(model.editModel.body),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(editModel.title),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(editModel.body),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Edit the stories'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _user$project$Editor_Views$storyLoadDiv(model),
					_1: {
						ctor: '::',
						_0: _user$project$Editor_Views$editStoryletForm(model.editModel),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$button,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Messages$UpdateFromEditModel),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
							...
							_1: {
								ctor: '::',
								_0: _user$project$Editor_Views$storyDisplay(model),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Events_Views$onwardsButton = F2(
	function (model, event) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Onwards!'),
				_1: {ctor: '[]'}
			});
	});
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A2(_user$project$Events_Views$onwardsButton, model, event),
						_1: {ctor: '[]'}
					}
				}
			});
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(storylet.title),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: A2(_user$project$Storylets_Views$buttonsForChoices, model.events, storylet.events),
						_1: {ctor: '[]'}
					}
				}
			});
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('The game should go here. Maybe external to Elm w/ ports?'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Views$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Ohai there bendyperson!'),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$Views$activityControl(model),
							_1: {
								ctor: '::',
								_0: A2(
								...
								_1: {
									ctor: '::',
									_0: _user$project$Views$viewForActivity(model),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Update$updateStorylet = F2(
	function (editModel, storyletDict) {
		var currentStorylet = A2(_user$project$Storylets_Models$storyletForId, storyletDict, editModel.currId);
		var newStorylet = _elm_lang$core$Native_Utils.update(
			currentStorylet,
			{title: editModel.title, body: editModel.body});
		return A3(_elm_lang$core$Dict$insert, newStorylet.id, newStorylet, storyletDict);
	});
var _user$project$Update$updateFromEditModel = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			storylets: A2(_user$project$Update$updateStorylet, model.editModel, model.storylets)
		});
};
			...
			case 'EditAction':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							editModel: A2(_user$project$Editor_Updates$editUpdate, _p0._0, model.editModel)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateFromEditModel':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Update$updateFromEditModel(model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
